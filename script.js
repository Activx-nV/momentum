...
const fontColor = document.getElementById("favcolor");
const bg = document.querySelector('.change-bg-button');
const warning = document.querySelector('.warning');

async function getQuote() {
  //if API doesn't work, then request a temporary access to the demo server once again here: https://cors-anywhere.herokuapp.com
...
fontColor.addEventListener("change", () => {
  ...
  bg.style.color = fontColor.value;
  warning.style.color = fontColor.value;
});
...
function setBgGreet() {
  ...
  if (hour < 12 && hour > 6) {
    ...
    switch (hour) {
      ...
      case 8:
        document.body.style.backgroundImage =
          "url('assets/images/morning/9.jpg')";
        break;
      case 9:
        document.body.style.backgroundImage =
    ...
    switch (hour) {
      case 12:
        document.body.style.backgroundImage = "url('assets/images/day/2.jpg')";
        break;
      case 13:
        document.body.style.backgroundImage = "url('assets/images/day/3.jpg')";
        break;
      case 14:
        document.body.style.backgroundImage = "url('assets/images/day/8.jpg')";
        break;
      case 15:
        document.body.style.backgroundImage = "url('assets/images/day/9.jpg')";
        break;
      case 16:
        document.body.style.backgroundImage = "url('assets/images/day/12.jpg')";
        break;
      case 17:
        document.body.style.backgroundImage = "url('assets/images/day/20.jpg')";
        break;
    }
    ...
    switch (hour) {
      case 00:
        document.body.style.backgroundImage = "url('assets/images/day/1.jpg')";
        break;
      case 24:
        document.body.style.backgroundImage = "url('assets/images/day/3.jpg')";
        break;
      case 1:
        ...
        break;
      case 2:
        document.body.style.backgroundImage = "url('assets/images/day/4.jpg')";
        break;
      case 3:
        document.body.style.backgroundImage = "url('assets/images/day/21.jpg')";
        break;
      case 4:
        document.body.style.backgroundImage = "url('assets/images/day/22.jpg')";
        break;
      case 5:
        document.body.style.backgroundImage = "url('assets/images/day/23.jpg')";
        break;
    }
